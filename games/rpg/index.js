...
const Clubber = badguy("Clubber", "He's stylish, he's angry and he's here to hit you.", EnemyBase.gen("clubber/clubber_angry"), { upd: (t) => {
    const r = 100;
    const s = 5;
...
const Bower = badguy("Bower", "Nothing is going on inside his head, but he will shoot you.", EnemyBase.gen("bower/bower_angry"), { upd: (t) => {}, attack: (t) => {} }, { w: 10, h: 30, hp: 10 });
const BigGuy = badguy("Big Guy", "A hulking beast of a man, no one dares mess with this titan.", EnemyBase.gen("big guy/big_guy_angry"), { upd: (t) => {}, attack: (t) => {} }, { w: 20, h: 30, hp: 100 });
const GraglonTheTerrible = badguy("Graglon The Terrible", "Angry, dangerous and ready to crush things.", EnemyBase.gen("graglon/graglon_the_terrible_angry"), { upd: (t) => {}, attack: (t) => {} }, { w: 50, h: 70, hp: 1000 });
const BiggerBalls = shopitem("Bigger Balls", "Make your balls bigger. And 19,48% more lethal.", UpgBase.gen("bigger_balls_upg"), 100, () => {});
const WarmerFire = shopitem("Warmer Fire", "Make your fires 22% warmer. Use responsibly.", UpgBase.gen("warm_fire_upg"), 100, () => {});
const PhoenixsWrath = shopitem("Phoenix's Wrath", "It's a bird! It's a plane! It's a Phoenix made of molten lava!", UpgBase.gen("phoenixs_wrath_upg"), 1000, () => {});
const PurePlasma = shopitem("Pure Plasma", "Sucked souls are now purer. Now that's a lot of plasma.", UpgBase.gen("pure_plasma_upg"), 100, () => {});
const MoreTroops = shopitem("More Troops", "And what army?", UpgBase.gen("more_troops_upg"), 100, () => {});
const SharpSwords = shopitem("Sharp Swords", "Sharper <i>and</i> stabbier. Leaks blood of enemies more effectively.", UpgBase.gen("sharp_swords_upg"), 100, () => {});
const CovertOps = shopitem("Covert Ops", "A RED Spy is in the base?!", UpgBase.gen("covert_ops_upg"), 2000, () => {});
...
shopIcon.tx = `<img src="assets/shop_icon.png" width="80px" height="70px">`;
const shopUI = new UI();
shopUI.style({
    "position": "fixed",
    "left": "0",
...
const wtwBase = new PathBase("assets/hero/wizzy/wizzy_the_wizard_", "png");
var i = 0;
...
const fredPath = EnemyBase.gen("fred/fred_the_cat");
...
const showClubberPopup = () => {
    clubberPopup.tx = txbox("assets/enemy/clubber/clubber_angry.png", "Clubber", "OOGA BOOGA.", nextBtn("Next"));
