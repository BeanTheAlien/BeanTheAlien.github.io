...
class Zombie extends Base {
    ...
    mspd;
    dmg;
    constructor(x, y, img, mhp, mspd = 2500, armor = 0, dmg = 1) {
        super(x, y, img, mhp);
        this.armor = armor;
        this.mspd = mspd;
...
plantMenu.addChilds(plantMenuOpt("menu1.png"), plantMenuOpt("menu2.png", 1), plantMenuOpt("menu3.png", 2), plantMenuOpt("menu4.png", 3));
